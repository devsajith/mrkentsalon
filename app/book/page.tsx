  ...
  if (!mounted || servicesLoading) {
    return (
      <div className="min-h-screen bg-surface flex items-center justify-center">
        <BarberScissorsLoader label="Loading Services..." />
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        ...
        <div className="md:col-span-7 space-y-6">
          ...
          <div className="bg-white rounded-2xl p-5 md:p-6 border border-border-light shadow-sm space-y-4">
            ...
            {slotsLoading ? (
              <BarberScissorsLoader size={48} label="Finding available slots..." />
            ) : selectedSlot && !isSlotExpanded ? (
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl bg-surface py-3.5 pl-11 pr-4 text-sm text-text-primary placeholder:text-text-muted outline-none border transition-all font-medium ${
                        nameError ? "border-red-500 focus:border-red-500 focus:ring-4 focus:ring-red-500/10" : "border-transparent focus:border-accent/30 focus:ring-4 focus:ring-accent/10"
                      }`}
                    />
                  </div>
                  {nameError && (
                ...
                <div>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl bg-surface py-3.5 pl-11 pr-4 text-sm text-text-primary placeholder:text-text-muted outline-none border transition-all font-medium ${
                        phoneError ? "border-red-500 focus:border-red-500 focus:ring-4 focus:ring-red-500/10" : "border-transparent focus:border-accent/30 focus:ring-4 focus:ring-accent/10"
                      }`}
                    />
                  </div>
                  {phoneError && (
                          ...
                          isSelected
                            ? isPremium
                              ...
                              : isCreative
                                ...
                                : "border-slate-600 bg-white text-text-primary"
                            : isPremium
